...
export const HeroBannerSlider: React.FC<HeroBannerSliderProps> = ({ onNavigate }) => {
  ...
  // Passive touch swipe handlers: NEVER call e.preventDefault() so vertical scrolling works freely
  ...
  const handleTouchEnd = (e: React.TouchEvent) => {
    ...
    if (e.changedTouches.length > 0) {
      ...
      // Only advance slide if swipe was predominantly horizontal and > 45px
  ...
  return (
    <div 
      ...
      className="relative rounded-3xl overflow-hidden shadow-xl border border-slate-200/80 bg-slate-900 group touch-pan-y slider-touch-pan-y"
