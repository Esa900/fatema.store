    ...
    >
      ...
      >
        ...
        <div
          ...
          className="flex items-stretch gap-3 sm:gap-4 overflow-x-auto scrollbar-none py-2 px-1 touch-pan-y slider-touch-pan-y snap-x snap-mandatory cursor-grab active:cursor-grabbing scroll-smooth"
        >
          {products.map((prod) => (
            <div 
              key={prod.id} 
