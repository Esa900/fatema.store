...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigate }) => {
  ...
  const [invoiceMode, setInvoiceMode] = useState<'invoice' | 'sticker' | 'challan'>('invoice');

  const handlePrintOrder = (ord: Order, mode: 'invoice' | 'sticker' | 'challan' = 'invoice') => {
    setInvoiceMode(mode);
    setInvoiceOrder(ord);
  };
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full">
          {activeTab === 'overview' && (
            <OverviewTab
              ...
              onPrintInvoice={(ord) => handlePrintOrder(ord, 'invoice')}
          ...
          {activeTab === 'orders' && (
            <OrdersTab
              ...
              onPrintInvoice={(ord, mode) => handlePrintOrder(ord, mode || 'invoice')}
